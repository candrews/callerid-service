...
class WhitePagesCanadaSource extends HTTPSource
{

    //The description cannot contain "a" tags, but can contain limited HTML. Some HTML (like the a tags) will break the UI.
    public $source_desc = "http://www.whitepages.ca - These listings will return both residential and business listings.";
