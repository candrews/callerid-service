...
class YellowPagesSource extends HTTPSource
{
    ...
    public $source_desc = "http://yellowpages.addresses.com - This will return only business listings, it will not return residential listings.<br><br>This data source requires Superfecta Module version 2.2.1 or higher.";
