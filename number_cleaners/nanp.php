...
class NanpNumberCleaner extends NumberCleaner
{
    static $npas = array(
        'us' => array(
    ...
    function clean_number($number){
	    ...
	    if(preg_match($pattern, $number, $matches)){
            ...
            foreach(self::$npas as $country=>$country_npas){
                if(in_array($npa, $country_npas)){
                    return array('number'=>$ret, 'country'=>$country);
                }
            }
            return false;
	    }else{
